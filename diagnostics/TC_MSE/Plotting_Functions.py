...
Model_mean_binned_data = xr.open_dataset(os.environ['WK_DIR']+'/model/Model_Binned_Composites.nc')
Model_std_binned_data = xr.open_dataset(os.environ['WK_DIR']+'/model/Model_Binned_STDEVS_of_BoxAvgs.nc')
    ...
    for b in allbins:
        ...
        for col in range(4):
            for row in range(6):
                ...
                if(row==0):
                    if(col==0):
                        im0 = ax.imshow(Model_mean_binned_data.hanom.sel(bin=b),cmap='bwr', vmin=-5e+7, vmax=5e+7, extent=[min(Model_mean_binned_data.lon),max(Model_mean_binned_data.lon),min(Model_mean_binned_data.lat),max(Model_mean_binned_data.lat)], origin='lower')
                        ax.autoscale(False)
                        ...
                        im1 = ax.imshow(Model_mean_binned_data.hanom_SEFanom.sel(bin=b),vmin=-2e+9,vmax=2e+9,cmap='bwr', extent=[min(Model_mean_binned_data.lon),max(Model_mean_binned_data.lon),min(Model_mean_binned_data.lat),max(Model_mean_binned_data.lat)], origin='lower')
                        ax.autoscale(False)
                        ...
                        im1 = ax.imshow(Model_mean_binned_data.hanom_LWanom.sel(bin=b),vmin=-2e+9,vmax=2e+9,cmap='bwr', extent=[min(Model_mean_binned_data.lon),max(Model_mean_binned_data.lon),min(Model_mean_binned_data.lat),max(Model_mean_binned_data.lat)], origin='lower')
                        ax.autoscale(False)
                        ...
                        im1 = ax.imshow(Model_mean_binned_data.hanom_SWanom.sel(bin=b),vmin=-2e+9,vmax=2e+9,cmap='bwr', extent=[min(Model_mean_binned_data.lon),max(Model_mean_binned_data.lon),min(Model_mean_binned_data.lat),max(Model_mean_binned_data.lat)], origin='lower')
                        ax.autoscale(False)
                    ...
                    if(col==0):
                        im0 = ax.imshow(JRA55_mean_binned_data.hanom.sel(bin=b),cmap='bwr', vmin=-5e+7, vmax=5e+7, extent=[min(JRA55_mean_binned_data.lon),max(JRA55_mean_binned_data.lon),min(JRA55_mean_binned_data.lat),max(JRA55_mean_binned_data.lat)], origin='lower')
                        ax.autoscale(False)
                        ...
                        im1 = ax.imshow(JRA55_mean_binned_data.hSEF_concat.sel(bin=b),vmin=-2e+9,vmax=2e+9,cmap='bwr', extent=[min(JRA55_mean_binned_data.lon),max(JRA55_mean_binned_data.lon),min(JRA55_mean_binned_data.lat),max(JRA55_mean_binned_data.lat)], origin='lower')
                        ax.autoscale(False)
                        cbar = fig.colorbar(im1,ax=ax)
                        cbar.ax.tick_params(labelsize=15)
                        cbar.ax.yaxis.get_offset_text().set_fontsize(15)
                        ...
                        im1 = ax.imshow(JRA55_mean_binned_data.hLW_concat.sel(bin=b),vmin=-2e+9,vmax=2e+9,cmap='bwr', extent=[min(JRA55_mean_binned_data.lon),max(JRA55_mean_binned_data.lon),min(JRA55_mean_binned_data.lat),max(JRA55_mean_binned_data.lat)], origin='lower')
                        ax.autoscale(False)
                        cbar = fig.colorbar(im1,ax=ax)
                        cbar.ax.tick_params(labelsize=15)
                        cbar.ax.yaxis.get_offset_text().set_fontsize(15)
                        ...
                        im1 = ax.imshow(JRA55_mean_binned_data.hSW_concat.sel(bin=b),vmin=-2e+9,vmax=2e+9,cmap='bwr', extent=[min(JRA55_mean_binned_data.lon),max(JRA55_mean_binned_data.lon),min(JRA55_mean_binned_data.lat),max(JRA55_mean_binned_data.lat)], origin='lower')
                        ax.autoscale(False)
                        cbar = fig.colorbar(im1,ax=ax)
                        cbar.ax.tick_params(labelsize=15)
                        cbar.ax.yaxis.get_offset_text().set_fontsize(15)
                    ...
                    if(col==0):
                        im0 = ax.imshow(MERRA2_mean_binned_data.hanom.sel(bin=b),cmap='bwr', vmin=-5e+7, vmax=5e+7, extent=[min(MERRA2_mean_binned_data.lon),max(MERRA2_mean_binned_data.lon),min(MERRA2_mean_binned_data.lat),max(MERRA2_mean_binned_data.lat)], origin='lower')
                        ax.autoscale(False)
                        ...
                        im1 = ax.imshow(MERRA2_mean_binned_data.hSEF_concat.sel(bin=b),vmin=-2e+9,vmax=2e+9,cmap='bwr', extent=[min(MERRA2_mean_binned_data.lon),max(MERRA2_mean_binned_data.lon),min(MERRA2_mean_binned_data.lat),max(MERRA2_mean_binned_data.lat)], origin='lower')
                        ax.autoscale(False)
                        cbar = fig.colorbar(im1,ax=ax)
                        cbar.ax.tick_params(labelsize=15)
                        cbar.ax.yaxis.get_offset_text().set_fontsize(15)
                        ...
                        im1 = ax.imshow(MERRA2_mean_binned_data.hLW_concat.sel(bin=b),vmin=-2e+9,vmax=2e+9,cmap='bwr', extent=[min(MERRA2_mean_binned_data.lon),max(MERRA2_mean_binned_data.lon),min(MERRA2_mean_binned_data.lat),max(MERRA2_mean_binned_data.lat)], origin='lower')
                        ax.autoscale(False)
                        cbar = fig.colorbar(im1,ax=ax)
                        cbar.ax.tick_params(labelsize=15)
                        cbar.ax.yaxis.get_offset_text().set_fontsize(15)
                        ...
                        im1 = ax.imshow(MERRA2_mean_binned_data.hSW_concat.sel(bin=b),vmin=-2e+9,vmax=2e+9,cmap='bwr', extent=[min(MERRA2_mean_binned_data.lon),max(MERRA2_mean_binned_data.lon),min(MERRA2_mean_binned_data.lat),max(MERRA2_mean_binned_data.lat)], origin='lower')
                        ax.autoscale(False)
                        cbar = fig.colorbar(im1,ax=ax)
                        cbar.ax.tick_params(labelsize=15)
                        cbar.ax.yaxis.get_offset_text().set_fontsize(15)
                    ...
                    if(col==0):
                        im0 = ax.imshow(CFSR_mean_binned_data.hanom.sel(bin=b),cmap='bwr', vmin=-5e+7, vmax=5e+7, extent=[min(CFSR_mean_binned_data.lon),max(CFSR_mean_binned_data.lon),min(CFSR_mean_binned_data.lat),max(CFSR_mean_binned_data.lat)], origin='lower')
                        ax.autoscale(False)
                        ...
                        im1 = ax.imshow(CFSR_mean_binned_data.hSEF_concat.sel(bin=b),vmin=-2e+9,vmax=2e+9,cmap='bwr', extent=[min(CFSR_mean_binned_data.lon),max(CFSR_mean_binned_data.lon),min(CFSR_mean_binned_data.lat),max(CFSR_mean_binned_data.lat)], origin='lower')
                        ax.autoscale(False)
                        cbar = fig.colorbar(im1,ax=ax)
                        cbar.ax.tick_params(labelsize=15)
                        cbar.ax.yaxis.get_offset_text().set_fontsize(15)
                        ...
                        im1 = ax.imshow(CFSR_mean_binned_data.hLW_concat.sel(bin=b),vmin=-2e+9,vmax=2e+9,cmap='bwr', extent=[min(CFSR_mean_binned_data.lon),max(CFSR_mean_binned_data.lon),min(CFSR_mean_binned_data.lat),max(CFSR_mean_binned_data.lat)], origin='lower')
                        ax.autoscale(False)
                        cbar = fig.colorbar(im1,ax=ax)
                        cbar.ax.tick_params(labelsize=15)
                        cbar.ax.yaxis.get_offset_text().set_fontsize(15)
                        ...
                        im1 = ax.imshow(CFSR_mean_binned_data.hSW_concat.sel(bin=b),vmin=-2e+9,vmax=2e+9,cmap='bwr', extent=[min(CFSR_mean_binned_data.lon),max(CFSR_mean_binned_data.lon),min(CFSR_mean_binned_data.lat),max(CFSR_mean_binned_data.lat)], origin='lower')
                        ax.autoscale(False)
                        cbar = fig.colorbar(im1,ax=ax)
                        cbar.ax.tick_params(labelsize=15)
                        cbar.ax.yaxis.get_offset_text().set_fontsize(15)
                    ...
                    if(col==0):
                        im0 = ax.imshow(ERAINT_mean_binned_data.hanom.sel(bin=b),cmap='bwr', vmin=-5e+7, vmax=5e+7, extent=[min(ERAINT_mean_binned_data.lon),max(ERAINT_mean_binned_data.lon),min(ERAINT_mean_binned_data.lat),max(ERAINT_mean_binned_data.lat)], origin='lower')
                        ax.autoscale(False)
                        ...
                        im1 = ax.imshow(ERAINT_mean_binned_data.hSEF_concat.sel(bin=b),vmin=-2e+9,vmax=2e+9,cmap='bwr', extent=[min(ERAINT_mean_binned_data.lon),max(ERAINT_mean_binned_data.lon),min(ERAINT_mean_binned_data.lat),max(ERAINT_mean_binned_data.lat)], origin='lower')
                        ax.autoscale(False)
                        cbar = fig.colorbar(im1,ax=ax)
                        cbar.ax.tick_params(labelsize=15)
                        cbar.ax.yaxis.get_offset_text().set_fontsize(15)
                        ...
                        im1 = ax.imshow(ERAINT_mean_binned_data.hLW_concat.sel(bin=b),vmin=-2e+9,vmax=2e+9,cmap='bwr', extent=[min(ERAINT_mean_binned_data.lon),max(ERAINT_mean_binned_data.lon),min(ERAINT_mean_binned_data.lat),max(ERAINT_mean_binned_data.lat)], origin='lower')
                        ax.autoscale(False)
                        cbar = fig.colorbar(im1,ax=ax)
                        cbar.ax.tick_params(labelsize=15)
                        cbar.ax.yaxis.get_offset_text().set_fontsize(15)
                        ...
                        im1 = ax.imshow(ERAINT_mean_binned_data.hSW_concat.sel(bin=b),vmin=-2e+9,vmax=2e+9,cmap='bwr', extent=[min(ERAINT_mean_binned_data.lon),max(ERAINT_mean_binned_data.lon),min(ERAINT_mean_binned_data.lat),max(ERAINT_mean_binned_data.lat)], origin='lower')
                        ax.autoscale(False)
                        cbar = fig.colorbar(im1,ax=ax)
                        cbar.ax.tick_params(labelsize=15)
                        cbar.ax.yaxis.get_offset_text().set_fontsize(15)
                    ...
                    if(col==0):
                        im0 = ax.imshow(ERA5_mean_binned_data.hanom.sel(bin=b),cmap='bwr', vmin=-5e+7, vmax=5e+7, extent=[min(ERA5_mean_binned_data.lon),max(ERA5_mean_binned_data.lon),min(ERA5_mean_binned_data.lat),max(ERA5_mean_binned_data.lat)], origin='lower')
                        ax.autoscale(False)
                        ...
                        im1 = ax.imshow(ERA5_mean_binned_data.hSEF_concat.sel(bin=b),vmin=-2e+9,vmax=2e+9,cmap='bwr', extent=[min(ERA5_mean_binned_data.lon),max(ERA5_mean_binned_data.lon),min(ERA5_mean_binned_data.lat),max(ERA5_mean_binned_data.lat)], origin='lower')
                        ax.autoscale(False)
                        cbar = fig.colorbar(im1,ax=ax)
                        cbar.ax.tick_params(labelsize=15)
                        cbar.ax.yaxis.get_offset_text().set_fontsize(15)
                        ...
                        im1 = ax.imshow(ERA5_mean_binned_data.hLW_concat.sel(bin=b),vmin=-2e+9,vmax=2e+9,cmap='bwr', extent=[min(ERA5_mean_binned_data.lon),max(ERA5_mean_binned_data.lon),min(ERA5_mean_binned_data.lat),max(ERA5_mean_binned_data.lat)], origin='lower')
                        ax.autoscale(False)
                        cbar = fig.colorbar(im1,ax=ax)
                        cbar.ax.tick_params(labelsize=15)
                        cbar.ax.yaxis.get_offset_text().set_fontsize(15)
                        ...
                        im1 = ax.imshow(ERA5_mean_binned_data.hSW_concat.sel(bin=b),vmin=-2e+9,vmax=2e+9,cmap='bwr', extent=[min(ERA5_mean_binned_data.lon),max(ERA5_mean_binned_data.lon),min(ERA5_mean_binned_data.lat),max(ERA5_mean_binned_data.lat)], origin='lower')
                        ax.autoscale(False)
                        cbar = fig.colorbar(im1,ax=ax)
                        cbar.ax.tick_params(labelsize=15)
                        cbar.ax.yaxis.get_offset_text().set_fontsize(15)
        ...
        plt.savefig(os.environ['WK_DIR']+'/Panel_Composites_'+blow+'_'+bup+'_Bin.pdf')
        plt.close()
...
def AzmeanPlotting():
    #Create azimuthal mean of bin mean profile, first create an array of radii (Use corresponding res. when setting up r's)
    ...
    for r in range(0,3):
        ...
        CFSR_azmean0 = azmean(CFSRlons,CFSRlats,CFSR_mean_binned_data[Reanalysis_var].sel(bin=16.5),0,0,CFSRrr)
        MERRA2_azmean0 = azmean(MERRA2lons,MERRA2lats,MERRA2_mean_binned_data[Reanalysis_var].sel(bin=16.5),0,0,MERRA2rr)
        JRA55_azmean0 = azmean(JRA55lons,JRA55lats,JRA55_mean_binned_data[Reanalysis_var].sel(bin=16.5),0,0,JRA55rr)
        ERA5_azmean0 = azmean(ERA5lons,ERA5lats,ERA5_mean_binned_data[Reanalysis_var].sel(bin=16.5),0,0,ERA5rr)
        ERAINT_azmean0 = azmean(ERAINTlons,ERAINTlats,ERAINT_mean_binned_data[Reanalysis_var].sel(bin=16.5),0,0,ERAINTrr)

        #az1 is 18-21 m/s bin
        Model_azmean1 = azmean(Modellons,Modellats,Model_mean_binned_data[model_var].sel(bin=19.5),0,0,Modelrr)
        CFSR_azmean1 = azmean(CFSRlons,CFSRlats,CFSR_mean_binned_data[Reanalysis_var].sel(bin=19.5),0,0,CFSRrr)
        MERRA2_azmean1 = azmean(MERRA2lons,MERRA2lats,MERRA2_mean_binned_data[Reanalysis_var].sel(bin=19.5),0,0,MERRA2rr)
        JRA55_azmean1 = azmean(JRA55lons,JRA55lats,JRA55_mean_binned_data[Reanalysis_var].sel(bin=19.5),0,0,JRA55rr)
        ERA5_azmean1 = azmean(ERA5lons,ERA5lats,ERA5_mean_binned_data[Reanalysis_var].sel(bin=19.5),0,0,ERA5rr)
        ERAINT_azmean1 = azmean(ERAINTlons,ERAINTlats,ERAINT_mean_binned_data[Reanalysis_var].sel(bin=19.5),0,0,ERAINTrr)

        #az2 is 21-24 m/s bin
        Model_azmean2 = azmean(Modellons,Modellats,Model_mean_binned_data[model_var].sel(bin=22.5),0,0,Modelrr)
        CFSR_azmean2 = azmean(CFSRlons,CFSRlats,CFSR_mean_binned_data[Reanalysis_var].sel(bin=22.5),0,0,CFSRrr)
        MERRA2_azmean2 = azmean(MERRA2lons,MERRA2lats,MERRA2_mean_binned_data[Reanalysis_var].sel(bin=22.5),0,0,MERRA2rr)
        JRA55_azmean2 = azmean(JRA55lons,JRA55lats,JRA55_mean_binned_data[Reanalysis_var].sel(bin=22.5),0,0,JRA55rr)
        ERA5_azmean2 = azmean(ERA5lons,ERA5lats,ERA5_mean_binned_data[Reanalysis_var].sel(bin=22.5),0,0,ERA5rr)
        ERAINT_azmean2 = azmean(ERAINTlons,ERAINTlats,ERAINT_mean_binned_data[Reanalysis_var].sel(bin=22.5),0,0,ERAINTrr)

        #az3 is 24-27 m/s bin
        Model_azmean3 = azmean(Modellons,Modellats,Model_mean_binned_data[model_var].sel(bin=25.5),0,0,Modelrr)
        CFSR_azmean3 = azmean(CFSRlons,CFSRlats,CFSR_mean_binned_data[Reanalysis_var].sel(bin=25.5),0,0,CFSRrr)
        MERRA2_azmean3 = azmean(MERRA2lons,MERRA2lats,MERRA2_mean_binned_data[Reanalysis_var].sel(bin=25.5),0,0,MERRA2rr)
        JRA55_azmean3 = azmean(JRA55lons,JRA55lats,JRA55_mean_binned_data[Reanalysis_var].sel(bin=25.5),0,0,JRA55rr)
        ERA5_azmean3 = azmean(ERA5lons,ERA5lats,ERA5_mean_binned_data[Reanalysis_var].sel(bin=25.5),0,0,ERA5rr)
        ERAINT_azmean3 = azmean(ERAINTlons,ERAINTlats,ERAINT_mean_binned_data[Reanalysis_var].sel(bin=25.5),0,0,ERAINTrr)

        #az4 is 27-30 m/s bin
        Model_azmean4 = azmean(Modellons,Modellats,Model_mean_binned_data[model_var].sel(bin=28.5),0,0,Modelrr)
        CFSR_azmean4 = azmean(CFSRlons,CFSRlats,CFSR_mean_binned_data[Reanalysis_var].sel(bin=28.5),0,0,CFSRrr)
        MERRA2_azmean4 = azmean(MERRA2lons,MERRA2lats,MERRA2_mean_binned_data[Reanalysis_var].sel(bin=28.5),0,0,MERRA2rr)
        JRA55_azmean4 = azmean(JRA55lons,JRA55lats,JRA55_mean_binned_data[Reanalysis_var].sel(bin=28.5),0,0,JRA55rr)
        ERA5_azmean4 = azmean(ERA5lons,ERA5lats,ERA5_mean_binned_data[Reanalysis_var].sel(bin=28.5),0,0,ERA5rr)
        ERAINT_azmean4 = azmean(ERAINTlons,ERAINTlats,ERAINT_mean_binned_data[Reanalysis_var].sel(bin=28.5),0,0,ERAINTrr)
        ...
        legend2 = ax.legend([line15_18,line18_21,line21_24,line24_27,line27_30],["15-18 m/s","18-21 m/s","21-24 m/s","24-27 m/s","27-30 m/s"],loc='upper right',fontsize=15)
        ...
        for r in range(0,2):
            ...
            for b in Model_mean_binned_data.bin[2:]:
                if(Model_mean_binned_data.bincounts.sel(bin=b)>2):
                    ...
                    Modelstderrorbars.append((Model_std_binned_data[modelvar].sel(bin=b))*1.96/((Model_mean_binned_data.bincounts.sel(bin=b))**(1/2)))
                if(ERAINT_mean_binned_data.bincounts.sel(bin=b)>2):
                    ...
                    #Gets the range of error bar for 5 to 95% confidence interval at each bin
                    ERAINTstderrorbars.append((ERAINT_std_binned_data[reanalysisvar].sel(bin=b))*1.96/((ERAINT_mean_binned_data.bincounts.sel(bin=b))**(1/2)))
                if(ERA5_mean_binned_data.bincounts.sel(bin=b)>2):
                    ...
                    #Gets the range of error bar for 5 to 95% confidence interval at each bin
                    ERA5stderrorbars.append((ERA5_std_binned_data[reanalysisvar].sel(bin=b))*1.96/((ERA5_mean_binned_data.bincounts.sel(bin=b))**(1/2)))
                if(CFSR_mean_binned_data.bincounts.sel(bin=b)>2):
                    ...
                    #Gets the range of error bar for 5 to 95% confidence interval at each bin
                    CFSRstderrorbars.append((CFSR_std_binned_data[reanalysisvar].sel(bin=b))*1.96/((CFSR_mean_binned_data.bincounts.sel(bin=b))**(1/2)))
                if(MERRA2_mean_binned_data.bincounts.sel(bin=b)>2):
                    ...
                    #Gets the range of error bar for 5 to 95% confidence interval at each bin
                    MERRA2stderrorbars.append((MERRA2_std_binned_data[reanalysisvar].sel(bin=b))*1.96/((MERRA2_mean_binned_data.bincounts.sel(bin=b))**(1/2)))
                if(JRA55_mean_binned_data.bincounts.sel(bin=b)>2):
                    ...
                    #Gets the range of error bar for 5 to 95% confidence interval at each bin
                    JRA55stderrorbars.append((JRA55_std_binned_data[reanalysisvar].sel(bin=b))*1.96/((JRA55_mean_binned_data.bincounts.sel(bin=b))**(1/2)))
    ...
    for r in range(0,3):
        ...
        for b in Model_mean_binned_data.bin[2:]:
            if(Model_mean_binned_data.bincounts.sel(bin=b)>2):
                ...
                #Gets the range of error bar for 5 to 95% confidence interval at each bin
                Modelnormstderrorbars.append((Model_std_binned_data[modelvar].sel(bin=b))*1.96/((Model_mean_binned_data.bincounts.sel(bin=b))**(1/2))*86400)
            if(ERAINT_mean_binned_data.bincounts.sel(bin=b)>2):
                #Append the bins that are >2
                ERAINT_bins.append(b)
                #Box avgs of variables
                ...
                #Gets the range of error bar for 5 to 95% confidence interval at each bin
                ERAINTnormstderrorbars.append((ERAINT_std_binned_data[reanalysisvar].sel(bin=b))*1.96/((ERAINT_mean_binned_data.bincounts.sel(bin=b))**(1/2))*86400)
            if(ERA5_mean_binned_data.bincounts.sel(bin=b)>2):
                #Append the bins that are >2
                ERA5_bins.append(b)
                #Box avgs of variables
                ...
                #Gets the range of error bar for 5 to 95% confidence interval at each bin
                ERA5normstderrorbars.append((ERA5_std_binned_data[reanalysisvar].sel(bin=b))*1.96/((ERA5_mean_binned_data.bincounts.sel(bin=b))**(1/2))*86400)
            if(CFSR_mean_binned_data.bincounts.sel(bin=b)>2):
                #Append the bins that are >2
                CFSR_bins.append(b)
                #Box avgs of variables
                ...
                #Gets the range of error bar for 5 to 95% confidence interval at each bin
                CFSRnormstderrorbars.append((CFSR_std_binned_data[reanalysisvar].sel(bin=b))*1.96/((CFSR_mean_binned_data.bincounts.sel(bin=b))**(1/2))*86400)
            if(MERRA2_mean_binned_data.bincounts.sel(bin=b)>2):
                #Append the bins that are >2
                MERRA2_bins.append(b)
                #Box avgs of variables
                ...
                #Gets the range of error bar for 5 to 95% confidence interval at each bin
                MERRA2normstderrorbars.append((MERRA2_std_binned_data[reanalysisvar].sel(bin=b))*1.96/((MERRA2_mean_binned_data.bincounts.sel(bin=b))**(1/2))*86400)
            if(JRA55_mean_binned_data.bincounts.sel(bin=b)>2):
                ...
                #Gets the range of error bar for 5 to 95% confidence interval at each bin
                JRA55normstderrorbars.append((JRA55_std_binned_data[reanalysisvar].sel(bin=b))*1.96/((JRA55_mean_binned_data.bincounts.sel(bin=b))**(1/2))*86400)
...
def BoxAvScatter():
    ...
    for row in range(4):
        ...
        Model_SEF_bars = Model_std_binned_data['new_boxav_hanom_SEFanom'].sel(bin=b) * 1.96 / ((Model_mean_binned_data.bincounts.sel(bin=b))**(1/2))
        Model_LW_bars = Model_std_binned_data['new_boxav_hanom_LWanom'].sel(bin=b) * 1.96 / ((Model_mean_binned_data.bincounts.sel(bin=b))**(1/2))
        Model_SW_bars = Model_std_binned_data['new_boxav_hanom_SWanom'].sel(bin=b) * 1.96 / ((Model_mean_binned_data.bincounts.sel(bin=b))**(1/2))

        ERA5_SEF_bars = ERA5_std_binned_data['new_boxav_hSEF_concat'].sel(bin=b) * 1.96 / ((ERA5_mean_binned_data.bincounts.sel(bin=b))**(1/2))
        ERA5_LW_bars = ERA5_std_binned_data['new_boxav_hLW_concat'].sel(bin=b) * 1.96 / ((ERA5_mean_binned_data.bincounts.sel(bin=b))**(1/2))
        ERA5_SW_bars = ERA5_std_binned_data['new_boxav_hSW_concat'].sel(bin=b) * 1.96 / ((ERA5_mean_binned_data.bincounts.sel(bin=b))**(1/2))

        ERAINT_SEF_bars = ERAINT_std_binned_data['new_boxav_hSEF_concat'].sel(bin=b) * 1.96 / ((ERAINT_mean_binned_data.bincounts.sel(bin=b))**(1/2))
        ERAINT_LW_bars = ERAINT_std_binned_data['new_boxav_hLW_concat'].sel(bin=b) * 1.96 / ((ERAINT_mean_binned_data.bincounts.sel(bin=b))**(1/2))
        ERAINT_SW_bars = ERAINT_std_binned_data['new_boxav_hSW_concat'].sel(bin=b) * 1.96 / ((ERAINT_mean_binned_data.bincounts.sel(bin=b))**(1/2))

        JRA55_SEF_bars = JRA55_std_binned_data['new_boxav_hSEF_concat'].sel(bin=b) * 1.96 / ((JRA55_mean_binned_data.bincounts.sel(bin=b))**(1/2))
        JRA55_LW_bars = JRA55_std_binned_data['new_boxav_hLW_concat'].sel(bin=b) * 1.96 / ((JRA55_mean_binned_data.bincounts.sel(bin=b))**(1/2))
        JRA55_SW_bars = JRA55_std_binned_data['new_boxav_hSW_concat'].sel(bin=b) * 1.96 / ((JRA55_mean_binned_data.bincounts.sel(bin=b))**(1/2))

        CFSR_SEF_bars = CFSR_std_binned_data['new_boxav_hSEF_concat'].sel(bin=b) * 1.96 / ((CFSR_mean_binned_data.bincounts.sel(bin=b))**(1/2))
        CFSR_LW_bars = CFSR_std_binned_data['new_boxav_hLW_concat'].sel(bin=b) * 1.96 / ((CFSR_mean_binned_data.bincounts.sel(bin=b))**(1/2))
        CFSR_SW_bars = CFSR_std_binned_data['new_boxav_hSW_concat'].sel(bin=b) * 1.96 / ((CFSR_mean_binned_data.bincounts.sel(bin=b))**(1/2))

        MERRA2_SEF_bars = MERRA2_std_binned_data['new_boxav_hSEF_concat'].sel(bin=b) * 1.96 / ((MERRA2_mean_binned_data.bincounts.sel(bin=b))**(1/2))
        MERRA2_LW_bars = MERRA2_std_binned_data['new_boxav_hLW_concat'].sel(bin=b) * 1.96 / ((MERRA2_mean_binned_data.bincounts.sel(bin=b))**(1/2))
        MERRA2_SW_bars = MERRA2_std_binned_data['new_boxav_hSW_concat'].sel(bin=b) * 1.96 / ((MERRA2_mean_binned_data.bincounts.sel(bin=b))**(1/2))
        ...
        #Get the errorbars of each box average above
        Model_normSEF_bars = Model_std_binned_data['new_boxav_norm_hanom_SEFanom'].sel(bin=b) * 1.96 / ((Model_mean_binned_data.bincounts.sel(bin=b))**(1/2)) * 86400
        Model_normLW_bars = Model_std_binned_data['new_boxav_norm_hanom_LWanom'].sel(bin=b) * 1.96 / ((Model_mean_binned_data.bincounts.sel(bin=b))**(1/2)) * 86400
        Model_normSW_bars = Model_std_binned_data['new_boxav_norm_hanom_SWanom'].sel(bin=b) * 1.96 / ((Model_mean_binned_data.bincounts.sel(bin=b))**(1/2)) * 86400

        ERA5_normSEF_bars = ERA5_std_binned_data['new_boxav_norm_hSEF_concat'].sel(bin=b) * 1.96 / ((ERA5_mean_binned_data.bincounts.sel(bin=b))**(1/2)) * 86400
        ERA5_normLW_bars = ERA5_std_binned_data['new_boxav_norm_hLW_concat'].sel(bin=b) * 1.96 / ((ERA5_mean_binned_data.bincounts.sel(bin=b))**(1/2)) * 86400
        ERA5_normSW_bars = ERA5_std_binned_data['new_boxav_norm_hSW_concat'].sel(bin=b) * 1.96 / ((ERA5_mean_binned_data.bincounts.sel(bin=b))**(1/2)) * 86400

        ERAINT_normSEF_bars = ERAINT_std_binned_data['new_boxav_norm_hSEF_concat'].sel(bin=b) * 1.96 / ((ERAINT_mean_binned_data.bincounts.sel(bin=b))**(1/2)) * 86400
        ERAINT_normLW_bars = ERAINT_std_binned_data['new_boxav_norm_hLW_concat'].sel(bin=b) * 1.96 / ((ERAINT_mean_binned_data.bincounts.sel(bin=b))**(1/2)) * 86400
        ERAINT_normSW_bars = ERAINT_std_binned_data['new_boxav_norm_hSW_concat'].sel(bin=b) * 1.96 / ((ERAINT_mean_binned_data.bincounts.sel(bin=b))**(1/2)) * 86400

        JRA55_normSEF_bars = JRA55_std_binned_data['new_boxav_norm_hSEF_concat'].sel(bin=b) * 1.96 / ((JRA55_mean_binned_data.bincounts.sel(bin=b))**(1/2)) * 86400
        JRA55_normLW_bars = JRA55_std_binned_data['new_boxav_norm_hLW_concat'].sel(bin=b) * 1.96 / ((JRA55_mean_binned_data.bincounts.sel(bin=b))**(1/2)) * 86400
        JRA55_normSW_bars = JRA55_std_binned_data['new_boxav_norm_hSW_concat'].sel(bin=b) * 1.96 / ((JRA55_mean_binned_data.bincounts.sel(bin=b))**(1/2)) * 86400

        CFSR_normSEF_bars = CFSR_std_binned_data['new_boxav_norm_hSEF_concat'].sel(bin=b) * 1.96 / ((CFSR_mean_binned_data.bincounts.sel(bin=b))**(1/2)) * 86400
        CFSR_normLW_bars = CFSR_std_binned_data['new_boxav_norm_hLW_concat'].sel(bin=b) * 1.96 / ((CFSR_mean_binned_data.bincounts.sel(bin=b))**(1/2)) * 86400
        CFSR_normSW_bars = CFSR_std_binned_data['new_boxav_norm_hSW_concat'].sel(bin=b) * 1.96 / ((CFSR_mean_binned_data.bincounts.sel(bin=b))**(1/2)) * 86400

        MERRA2_normSEF_bars = MERRA2_std_binned_data['new_boxav_norm_hSEF_concat'].sel(bin=b) * 1.96 / ((MERRA2_mean_binned_data.bincounts.sel(bin=b))**(1/2)) * 86400
        MERRA2_normLW_bars = MERRA2_std_binned_data['new_boxav_norm_hLW_concat'].sel(bin=b) * 1.96 / ((MERRA2_mean_binned_data.bincounts.sel(bin=b))**(1/2)) * 86400
        MERRA2_normSW_bars = MERRA2_std_binned_data['new_boxav_norm_hSW_concat'].sel(bin=b) * 1.96 / ((MERRA2_mean_binned_data.bincounts.sel(bin=b))**(1/2)) * 86400
        ...
        for col in range(2):
            ...
            if(col==0):
                ...
                leg2 = ax.legend([SEFfeedbackleg,LWfeedbackleg,SWfeedbackleg],["h'SEF'","h'LW'","h'SW'"],loc='center left', bbox_to_anchor=(1, 0.4),fontsize=16)
                ax.add_artist(leg1)
                ax.add_artist(leg2)
                ...
                ax.scatter(MERRA2_normLW,MERRA2_percent,marker='o',facecolors='white',edgecolors='lightgrey',s=size)
                ...
                #Plot Features
                ax.set_title('Normalized Box Average Feedbacks '+blow+'-'+bup+' m/s Bin',fontweight='bold',fontsize=20)
    ...
    plt.suptitle('Scatter Plots of Percent of Storms Intensifying as Function of Box-Averaged Feedback', fontweight='bold', fontsize=35)
    plt.subplots_adjust(hspace=0.35,wspace=0.3)
    plt.savefig(os.environ['WK_DIR']+'/Scattered_Feedbacks.pdf')
    plt.close()
